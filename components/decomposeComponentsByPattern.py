...
class Dialog:
    def __init__(self):
        ...
        self.window.pattern_label = vanilla.TextBox(
            (15, 15, -15, 20), "Select Glyph as Input", sizeStyle="small"
        )
        self.window.pattern = vanilla.EditText(
            (15, 35, -15, 20), Glyphs.defaults[pattern_default], sizeStyle="small"
        )
        self.window.process = vanilla.Button(
            (15, 65, -15, 20), "Decompose", sizeStyle="small", callback=self.decompose
        )
        self.window.open()
