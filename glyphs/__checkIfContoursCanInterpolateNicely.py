        ...
        for path in path_across_layer:
            ...
            for n in range(len(nodes)):
                ...
                if node.type == "offcurve" and prev_node.type == "curve":
                    ...
                    node.type == "curve"
                    and prev_node.type == "offcurve"
                    and next_node.type == "curve"
                ):
                    ...
                    guess_smooth = hypot(
                        prev_node.x - node.x, prev_node.y - node.y
                    ), hypot(node.x - next_node.x, node.y - next_node.y)
